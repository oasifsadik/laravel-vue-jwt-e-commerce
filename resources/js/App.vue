<template>
    ...
    <header class="ltn__header-area ltn__header-3 section-bg-6---">   
        ...
        <div class="header-bottom-area ltn__header-sticky ltn__sticky-bg-white d-none--- d-lg-block">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-2 align-self-center d-none d-xl-block">
                        <div class="header-contact-info text-end">
                            <a class="font-weight-6 ltn__primary-color" href="tel:+123456789">
                                <span class="ltn__secondary-color"><i class="icon-call font-weight-7"></i></span> +123-456-789-10
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="modal-product-info">
                                            ...
                                            <div class="ltn__product-details-menu-2">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="#" class="theme-btn-1 btn btn-effect-1" data-bs-toggle="modal" data-bs-target="#add_to_cart_modal">
                                                            <i class="fas fa-shopping-cart"></i>
